...
describe('Post Routes', () => {
  ...
  describe('POST /posts/add', () => {
    it('should create a new post', async () => {
      ...
      (handleImageUpload as jest.Mock).mockResolvedValue('/uploads/posts/new-post.jpg');
      ...
      const response = await request(app)
        ...
        .field('user', '1')
        .attach('image', path.join(__dirname, '../../tests/fixtures/test-profile.jpg'));
  ...
  describe('PUT /posts/:id', () => {
    it('should update a post', async () => {
      ...
      (prismaClient.post.findFirst as jest.Mock).mockResolvedValue({ id: 1, content: 'Original post' });
      (handleImageUpload as jest.Mock).mockResolvedValue('/uploads/posts/updated-post.jpg');
      (PostSchema.parse as jest.Mock).mockReturnValue(true);
      ...
      const response = await request(app)
        ...
        .attach('file', path.join(__dirname, '../../tests/fixtures/test-profile.jpg'));
